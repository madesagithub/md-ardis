	...
	<div class="container">
		<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
			...
			<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
				...
				<li><a href="{{ route('projeto.index') }}" class="nav-link px-2 text-white {{ Route::currentRouteName() === 'projeto.index' ? 'text-secondary' : 'text-white' }}">Projetos</a></li>
				<li><a href="{{ route('movement.index') }}" class="nav-link px-2 text-white {{ Route::currentRouteName() === 'movement.index' ? 'text-secondary' : 'text-white' }}">Movimentações</a></li>
